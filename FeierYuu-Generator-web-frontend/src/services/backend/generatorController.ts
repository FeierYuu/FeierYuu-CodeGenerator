...
/** getGeneratorVOById GET /api/generator/get */
export async function getGeneratorVoByIdUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getGeneratorVOByIdUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseGeneratorVO_>('/api/generator/get', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listGeneratorUsingGet(
  ...
  return request<API.BaseResponseListGenerator_>('/api/generator/list', {
    method: 'GET',
    params: {
      ...params,
    },
