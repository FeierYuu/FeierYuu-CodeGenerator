...
import com.feieryuu.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "FeierYuu");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.FeierYuu");
